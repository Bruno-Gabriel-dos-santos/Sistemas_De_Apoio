        ...
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <div class="mb-8">
                ...
                <div id="addBookForm" class="space-y-4 mt-4 hidden">
                    <?php echo csrf_field(); ?> <!-- Manter para obter o token CSRF -->
            ...
            <div>
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="<?php echo e(route('livros.progresso.index')); ?>" 
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__currentLoopData = $livros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $livro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 max-w-[200px] truncate" title="<?php echo e($livro->original_filename); ?>"><?php echo e($livro->original_filename ?? 'N/A'); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 max-w-[180px] truncate" title="<?php echo e($livro->titulo); ?>"><?php echo e($livro->titulo); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 max-w-[150px] truncate" title="<?php echo e($livro->autor); ?>"><?php echo e($livro->autor); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 max-w-[120px] truncate" title="<?php echo e($livro->categoria); ?>"><?php echo e($livro->categoria); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 max-w-[120px] truncate" title="<?php echo e($livro->genero); ?>"><?php echo e($livro->genero); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 max-w-[120px] truncate" title="<?php echo e($livro->materia); ?>"><?php echo e($livro->materia ?? 'N/A'); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($livro->data_publicacao ? date('d/m/Y', strtotime($livro->data_publicacao)) : 'N/A'); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                <?php echo e(match ($livro->status) {
                                                ...
                                                <?php echo e(ucfirst($livro->status)); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex flex-col space-y-1">
                                                <?php if($livro->status === 'completo' && $livro->hash): ?>
                                                    <a href="<?php echo e(route('livros.downloadByHash', $livro->hash)); ?>" 
                                                    ...
                                                    <a href="#" onclick="visualizarPDF('<?php echo e($livro->hash); ?>')" 
                                                ...
                                                <form action="<?php echo e(route('livros.destroy', $livro->id)); ?>" method="POST" class="inline">
                                                    ...
                                                    <button type="button" onclick="confirmarExclusao(<?php echo e($livro->id); ?>)" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.visualizarPDF = function(hash) {
        ...
        const viewerUrl = `<?php echo e(url('/livros/view')); ?>/${hash}`;
    ...
    async function handleSaveClick() {
        ...
        try {
            ...
            const validateResponse = await fetch('<?php echo e(route("livros.validateData")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
            ...
            async function uploadNextChunk() {
                ...
                try {
                    ...
                    const chunkResponse = await fetch('<?php echo e(route("livros.uploadChunk")); ?>', {
                        method: 'POST',
                        body: chunkFormData,
                        headers: {
                            'Accept': 'application/json',
    ...
    async function completeUpload(hash, totalChunks) {
         try {
             ...
             const completeResponse = await fetch('<?php echo e(route("livros.completeUpload")); ?>', {
                 method: 'POST',
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bruno/composer_sites/Sistemas_de_Apoio_10/resources/views/livros/index.blade.php ENDPATH**/ ?>