...
<div class="min-h-[80vh] flex bg-white rounded shadow-lg overflow-hidden mt-4">
    ...
    <aside class="w-1/5 bg-white/80 border-r p-6 flex flex-col gap-6 shadow-lg rounded-xl mt-4 ml-2 mb-2">
        ...
        <div>
            ...
            <p class="text-gray-700 text-left"><span class="font-semibold">Descrição:</span> <?php echo e($sistema->descricao); ?></p>
            <p class="text-gray-700 text-center"><span class="font-semibold">Data de Criação:</span> <?php echo e($sistema->created_at); ?></p>
            <p class="text-gray-700 text-center"><span class="font-semibold">Data de Atualização:</span> <?php echo e($sistema->updated_at); ?></p>
