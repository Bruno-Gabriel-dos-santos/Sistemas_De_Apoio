...
<div class="container mx-auto px-4 py-8">
    ...
    <form id="form-pagina" action="<?php echo e(route('paginas_sistemas.store', $sistema->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="mb-4">
        ...
        <div class="flex gap-2">
            ...
            <a href="<?php echo e(route('sistemas.show', $sistema->id)); ?>" class="ml-2 bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded border">Voltar</a>
        </div>
    </form>
    <div class="mt-8">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bruno/composer_sites/Sistemas_de_Apoio_10/resources/views/paginas_sistemas/create.blade.php ENDPATH**/ ?>