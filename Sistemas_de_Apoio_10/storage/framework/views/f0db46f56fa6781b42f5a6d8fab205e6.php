...
<div class="container mx-auto px-4 py-8">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        <h1 class="text-2xl font-bold text-gray-800 mb-2"><?php echo e($sistema->nome); ?></h1>
        <span class="text-lg text-gray-500">Categoria: <span class="font-bold text-indigo-700"><?php echo e($sistema->categoria); ?></span></span>
    </div>
    ...
    <div id="quadro-paginas" class="bg-white rounded-b-xl shadow-lg p-6 block">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xs text-gray-500">Total: <span id="pagina-atual" class="font-bold">1</span> de <span id="total-paginas" class="font-bold"><?php echo e($posts->count()); ?></span></span>
                    <button type="button" id="btn-proxima" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-2 py-1 rounded">&rarr;</button>
                </div>
            </div>
            <div class="flex gap-2">
                <a href="<?php echo e(route('paginas_sistemas.create', $sistema->id)); ?>" class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded shadow text-sm">Nova Página</a>
        ...
        <?php else: ?>
            ...
            <div id="visualizacao-pagina-blog" class="border rounded p-6 bg-gray-50">
                <h1 class="text-2xl font-bold text-indigo-800 mb-2"><?php echo e($pagina->titulo); ?></h1>
                <div class="text-xs text-gray-500 mb-2"><?php echo e($pagina->data ? substr($pagina->data, 0, 10) : ''); ?></div>
                <div class="text-base text-gray-700 mb-4"><?php echo e($pagina->descricao); ?></div>
                <hr class="mb-4">
...
<div id="quadro-arquivos" class="hidden flex w-[90vw] mx-auto">
    <?php echo $__env->make('components.gerenciador-arquivos', ['sistema' => $sistema], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
...
const posts = <?php echo json_encode($posts->values(), 15, 512) ?>;
let idxAtual = 0;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bruno/composer_sites/Sistemas_de_Apoio_10/resources/views/sistemas/show.blade.php ENDPATH**/ ?>