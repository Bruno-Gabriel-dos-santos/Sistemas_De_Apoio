...
<div class="mx-auto py-8" style="width: 80%;">
    <div class="flex justify-end mb-4 gap-2">
        <a href="<?php echo e(route('estudos.edit', $estudo->id)); ?>" class="bg-yellow-400 hover:bg-yellow-500 text-white font-bold py-2 px-4 rounded">Editar</a>
        <form id="form-deletar-<?php echo e($estudo->id); ?>" action="<?php echo e(route('estudos.destroy', $estudo->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php echo method_field('DELETE'); ?>
            <button type="button" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onclick="abrirModalSenha(<?php echo e($estudo->id); ?>)">Deletar</button>
        </form>
    </div>
    <div class="bg-white rounded-lg shadow p-6">
        <img src="<?php echo e(asset('storage/' . $estudo->capa)); ?>" alt="Capa" class="w-full h-64 object-cover rounded mb-4">
        <h1 class="text-3xl font-bold mb-2"><?php echo e($estudo->titulo); ?></h1>
        <div class="flex justify-between text-sm text-gray-500 mb-4">
            <span>Autor: <?php echo e($estudo->autor); ?></span>
            <span><?php echo e(\Carbon\Carbon::parse($estudo->data)->format('d/m/Y')); ?></span>
            <?php if($estudo->tag): ?>
                <span class="bg-blue-100 text-blue-800 px-2 py-1 rounded"><?php echo e($estudo->tag); ?></span>
            <?php endif; ?>
        </div>
        <div class="prose max-w-none"><?php echo $estudo->conteudo; ?></div>
    </div>
</div>
<!-- Modal de senha -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bruno/composer_sites/Sistemas_de_Apoio_10/resources/views/estudos/show.blade.php ENDPATH**/ ?>