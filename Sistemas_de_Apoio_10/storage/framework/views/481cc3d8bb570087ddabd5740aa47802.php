<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <?php $__empty_1 = true; $__currentLoopData = $sistemas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sistema): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="bg-white rounded-xl shadow-lg border p-6 flex flex-col justify-between hover:shadow-2xl transition cursor-pointer relative" onclick="window.location.href='/sistemas/<?php echo e($sistema->nome); ?>'">
            <!-- Ícone de lixeira -->
            <button type="button" onclick="event.stopPropagation(); abrirModalSenha(<?php echo e($sistema->id); ?>)" class="absolute top-2 right-2 text-gray-400 hover:text-red-600 focus:outline-none" title="Excluir Sistema">
            ...
            <div>
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-gray-800"><?php echo e($sistema->titulo); ?></h2>
                        <p class="text-xs text-gray-500"><?php echo e($sistema->nome); ?></p>
                    </div>
                </div>
                <p class="text-gray-600 text-sm mb-2"><?php echo e(Str::limit($sistema->descricao, 80)); ?></p>
            </div>
            <div class="flex items-center justify-between mt-4 w-full">
                <span class="text-xs text-gray-400 flex-1 text-left">ID: <?php echo e($sistema->id); ?></span>
                <?php if($sistema->categoria): ?>
                    <span class="font-bold text-indigo-700 text-xs flex-1 text-center"><?php echo e($sistema->categoria); ?></span>
                <?php else: ?>
                    <span class="flex-1"></span>
                <?php endif; ?>
                <span class="text-xs text-gray-400 flex-1 text-right"><?php echo e($sistema->data_inicio ? $sistema->data_inicio->format('d/m/Y') : ''); ?></span>
            </div>
            <form id="form-excluir-<?php echo e($sistema->id); ?>" action="<?php echo e(route('sistemas.destroyCompleto', $sistema->id)); ?>" method="POST" class="mt-2">
                <?php echo csrf_field(); ?>
...
</script> <?php /**PATH /home/bruno/composer_sites/Sistemas_de_Apoio_10/resources/views/sistemas/partials/cards.blade.php ENDPATH**/ ?>