...
<div class="mx-auto py-8" style="width: 80%;">
    <div class="flex justify-end mb-4 gap-2">
        <a href="{{ route('interfaces-hiperprocessamento.edit', $post->id) }}" class="bg-yellow-400 hover:bg-yellow-500 text-white font-bold py-2 px-4 rounded">Editar</a>
        <form id="form-deletar-{{ $post->id }}" action="{{ route('interfaces-hiperprocessamento.destroy', $post->id) }}" method="POST">
            @csrf
            @method('DELETE')
